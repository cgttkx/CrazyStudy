...
public class ExpandableListActivityTest extends ExpandableListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 创建BaseExpandableListAdapter子类实例
        BaseExpandableListAdapter adapter=new BaseExpandableListAdapter() {
            int[] logos = new int[]{R.drawable.p1, R.drawable.p2, R.drawable.p3};
            String[] armTypes = new String[]{"神族兵种", "虫族兵种", "人族兵种"};
            String[][] arms = new String[][]{new String[]{"狂战士", "龙骑士", "黑暗圣堂", "电兵"},
                                             new String[]{"小狗", "刺蛇", "飞龙", "自爆飞机"},
                                             new String[]{"机枪兵", "护士MM", "幽灵"}};

            @Override
            public int getGroupCount() { return armTypes.length; }

            @Override
            public int getChildrenCount(int groupPosition) { return arms[groupPosition].length; }
            // 获取指定组位置处的组数据
            @Override
            public Object getGroup(int groupPosition) { return armTypes[groupPosition]; }
            ...
            public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    ImageView logo = this.getImageView();
                    ll.addView(logo);
